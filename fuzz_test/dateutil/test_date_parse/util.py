...
def analyze_test_results(prefix, logs_dir="logs"):
    """
    ...
    mutation_files = [f for f in all_files if f.startswith(prefix+"_")]
    ...
    for mutation_file in tqdm(mutation_files, desc="Analyzing logs"):
        suffix = mutation_file[len(prefix)+1:]
...
if __name__ == "__main__":
    ...
    analyze_test_results("mutation1", "logs")